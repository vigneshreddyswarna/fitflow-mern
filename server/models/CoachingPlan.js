...
const coachingPlanSchema = new mongoose.Schema({
  ...
  sessions: [{ day: String, title: String, type: String, minutes: Number, instructions: String, classId: { type: mongoose.Schema.Types.ObjectId, ref: 'FitnessClass' }, completed: { type: Boolean, default: false } }],
